...
latex_documents = [
    (master_doc, 'lbt-recipes.tex', 'lbt-recipes Documentation',
...
man_pages = [
    (master_doc, 'lbt-recipes', 'lbt-recipes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lbt-recipes', 'lbt-recipes Documentation',
     author, 'lbt-recipes', 'One line description of project.',
     'Miscellaneous'),
]
