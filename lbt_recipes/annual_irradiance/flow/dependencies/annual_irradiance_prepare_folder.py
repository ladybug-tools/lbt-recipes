...
class _AnnualIrradiancePrepareFolder_9d3bb717Orchestrator(luigi.WrapperTask):
    ...
    def requires(self):
        yield [CreateDirectSky(_input_params=self.input_values), CreateSkyDome(_input_params=self.input_values), CreateTotalSky(_input_params=self.input_values), CreateOctree(_input_params=self.input_values), CreateOctreeWithSuns(_input_params=self.input_values), ParseSunUpHours(_input_params=self.input_values), CopyRedistInfo(_input_params=self.input_values)]
