...
from .dependencies.two_phase_simulation import _TwoPhaseSimulation_98cdfd83Orchestrator as TwoPhaseSimulation_98cdfd83Workerbee
from .dependencies.two_phase_prepare_folder import _TwoPhasePrepareFolder_98cdfd83Orchestrator as TwoPhasePrepareFolder_98cdfd83Workerbee
...
class PrepareFolderAnnualDaylight(QueenbeeTask):
    ...
    def run(self):
        yield [TwoPhasePrepareFolder_98cdfd83Workerbee(_input_params=self.map_dag_inputs)]
...
class CalculateTwoPhaseMatrixLoop(luigi.Task):
    ...
    def run(self):
        yield [TwoPhaseSimulation_98cdfd83Workerbee(_input_params=self.map_dag_inputs)]
...
class _Main_98cdfd83Orchestrator(luigi.WrapperTask):
