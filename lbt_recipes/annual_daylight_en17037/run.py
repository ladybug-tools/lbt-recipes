...
import flow.main_f7730ca9 as annual_daylight_en17037_workerbee
...
class LetAnnualDaylightEn17037Fly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [annual_daylight_en17037_workerbee._Main_f7730ca9Orchestrator(_input_params=self._input_params)]
