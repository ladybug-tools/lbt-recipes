...
from .dependencies.spherical_view_factor import _SphericalViewFactor_73edd45fOrchestrator as SphericalViewFactor_73edd45fWorkerbee
...
class CalculateSphericalViewFactorsLoop(luigi.Task):
    ...
    def run(self):
        yield [SphericalViewFactor_73edd45fWorkerbee(_input_params=self.map_dag_inputs)]
...
class _SphericalViewFactorEntryPoint_73edd45fOrchestrator(luigi.WrapperTask):
