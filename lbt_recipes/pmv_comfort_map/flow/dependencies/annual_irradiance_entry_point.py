...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_6d4da049Orchestrator as AnnualIrradianceRayTracing_6d4da049Workerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_6d4da049Workerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_6d4da049Orchestrator(luigi.WrapperTask):
