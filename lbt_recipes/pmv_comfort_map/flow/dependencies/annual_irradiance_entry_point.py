...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_6ef32636Orchestrator as AnnualIrradianceRayTracing_6ef32636Workerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_6ef32636Workerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_6ef32636Orchestrator(luigi.WrapperTask):
