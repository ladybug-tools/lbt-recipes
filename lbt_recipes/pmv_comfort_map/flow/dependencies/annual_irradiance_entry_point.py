...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_88e76ab8Orchestrator as AnnualIrradianceRayTracing_88e76ab8Workerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_88e76ab8Workerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_88e76ab8Orchestrator(luigi.WrapperTask):
