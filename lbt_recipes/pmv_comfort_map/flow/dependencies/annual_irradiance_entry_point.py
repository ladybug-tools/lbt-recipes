...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_34bf01fdOrchestrator as AnnualIrradianceRayTracing_34bf01fdWorkerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_34bf01fdWorkerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_34bf01fdOrchestrator(luigi.WrapperTask):
