...
class ProcessPmvMatrix(QueenbeeTask):
    ...
    @property
    def __script__(self):
        return pathlib.Path(__file__).parent.joinpath('scripts', 'process_pmv_matrix.py').resolve()
    ...
    def input_artifacts(self):
        return [
            ...
            {'name': 'met_rate', 'to': 'met.txt', 'from': self.met_rate, 'optional': True},
            {'name': 'clo_value', 'to': 'clo.txt', 'from': self.clo_value, 'optional': True}]
