...
from .dependencies.shade_contrib_entry_point import _ShadeContribEntryPoint_ab2b8200Orchestrator as ShadeContribEntryPoint_ab2b8200Workerbee
...
class RunRadianceShadeContribLoop(luigi.Task):
    ...
    def run(self):
        yield [ShadeContribEntryPoint_ab2b8200Workerbee(_input_params=self.map_dag_inputs)]
...
class _DynamicShadeContribEntryPoint_ab2b8200Orchestrator(luigi.WrapperTask):
