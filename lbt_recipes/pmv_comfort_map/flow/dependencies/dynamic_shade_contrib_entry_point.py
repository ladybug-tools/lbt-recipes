...
from .dependencies.shade_contrib_entry_point import _ShadeContribEntryPoint_5a88f95cOrchestrator as ShadeContribEntryPoint_5a88f95cWorkerbee
...
class RunRadianceShadeContribLoop(luigi.Task):
    ...
    def run(self):
        yield [ShadeContribEntryPoint_5a88f95cWorkerbee(_input_params=self.map_dag_inputs)]
