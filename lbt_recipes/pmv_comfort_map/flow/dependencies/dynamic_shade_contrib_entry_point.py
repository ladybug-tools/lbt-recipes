...
from .dependencies.shade_contrib_entry_point import _ShadeContribEntryPoint_73edd45fOrchestrator as ShadeContribEntryPoint_73edd45fWorkerbee
...
class RunRadianceShadeContribLoop(luigi.Task):
    ...
    def run(self):
        yield [ShadeContribEntryPoint_73edd45fWorkerbee(_input_params=self.map_dag_inputs)]
...
class _DynamicShadeContribEntryPoint_73edd45fOrchestrator(luigi.WrapperTask):
