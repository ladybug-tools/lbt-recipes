...
from .dependencies.shade_contrib_entry_point import _ShadeContribEntryPoint_5972ee0cOrchestrator as ShadeContribEntryPoint_5972ee0cWorkerbee
...
class RunRadianceShadeContribLoop(luigi.Task):
    ...
    def run(self):
        yield [ShadeContribEntryPoint_5972ee0cWorkerbee(_input_params=self.map_dag_inputs)]
...
class _DynamicShadeContribEntryPoint_5972ee0cOrchestrator(luigi.WrapperTask):
