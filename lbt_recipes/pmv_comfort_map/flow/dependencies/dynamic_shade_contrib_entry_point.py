...
from .dependencies.shade_contrib_entry_point import _ShadeContribEntryPoint_6b2d7cbaOrchestrator as ShadeContribEntryPoint_6b2d7cbaWorkerbee
...
class RunRadianceShadeContribLoop(luigi.Task):
    ...
    def run(self):
        yield [ShadeContribEntryPoint_6b2d7cbaWorkerbee(_input_params=self.map_dag_inputs)]
...
class _DynamicShadeContribEntryPoint_6b2d7cbaOrchestrator(luigi.WrapperTask):
