...
from .dependencies.two_phase_simulation import _TwoPhaseSimulation_b117d182Orchestrator as TwoPhaseSimulation_b117d182Workerbee
from .dependencies.two_phase_prepare_folder import _TwoPhasePrepareFolder_b117d182Orchestrator as TwoPhasePrepareFolder_b117d182Workerbee
...
class PrepareFolderAnnualDaylight(QueenbeeTask):
    ...
    def run(self):
        yield [TwoPhasePrepareFolder_b117d182Workerbee(_input_params=self.map_dag_inputs)]
...
class CalculateTwoPhaseMatrixLoop(luigi.Task):
    ...
    def run(self):
        yield [TwoPhaseSimulation_b117d182Workerbee(_input_params=self.map_dag_inputs)]
...
class _Main_b117d182Orchestrator(luigi.WrapperTask):
