...
from .dependencies.two_phase_ray_tracing import _TwoPhaseRayTracing_b117d182Orchestrator as TwoPhaseRayTracing_b117d182Workerbee
...
class TwoPhaseRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [TwoPhaseRayTracing_b117d182Workerbee(_input_params=self.map_dag_inputs)]
...
class _TwoPhaseSimulation_b117d182Orchestrator(luigi.WrapperTask):
