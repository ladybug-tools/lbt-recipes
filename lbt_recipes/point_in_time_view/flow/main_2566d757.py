...
from .dependencies.point_in_time_view_ray_tracing import _PointInTimeViewRayTracing_2566d757Orchestrator as PointInTimeViewRayTracing_2566d757Workerbee
from .dependencies.point_in_time_view_prepare_folder import _PointInTimeViewPrepareFolder_2566d757Orchestrator as PointInTimeViewPrepareFolder_2566d757Workerbee
...
class PrepareFolderPointInTimeView(QueenbeeTask):
    ...
    def run(self):
        yield [PointInTimeViewPrepareFolder_2566d757Workerbee(_input_params=self.map_dag_inputs)]
...
class PointInTimeViewRayTracingLoop(luigi.Task):
    ...
    def run(self):
        yield [PointInTimeViewRayTracing_2566d757Workerbee(_input_params=self.map_dag_inputs)]
...
class _Main_2566d757Orchestrator(luigi.WrapperTask):
