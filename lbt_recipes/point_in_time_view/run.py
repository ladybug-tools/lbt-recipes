...
import flow.main_7ccae81f as point_in_time_view_workerbee
...
class LetPointInTimeViewFly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [point_in_time_view_workerbee._Main_7ccae81fOrchestrator(_input_params=self._input_params)]
