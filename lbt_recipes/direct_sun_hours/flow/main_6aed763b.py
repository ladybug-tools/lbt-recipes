...
from .dependencies.direct_sun_hours_calculation import _DirectSunHoursCalculation_6aed763bOrchestrator as DirectSunHoursCalculation_6aed763bWorkerbee
from .dependencies.direct_sun_hours_postprocess import _DirectSunHoursPostprocess_6aed763bOrchestrator as DirectSunHoursPostprocess_6aed763bWorkerbee
from .dependencies.direct_sun_hours_prepare_folder import _DirectSunHoursPrepareFolder_6aed763bOrchestrator as DirectSunHoursPrepareFolder_6aed763bWorkerbee
...
class PrepareFolderDirectSunHours(QueenbeeTask):
    ...
    def run(self):
        yield [DirectSunHoursPrepareFolder_6aed763bWorkerbee(_input_params=self.map_dag_inputs)]
...
class DirectSunHoursRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [DirectSunHoursCalculation_6aed763bWorkerbee(_input_params=self.map_dag_inputs)]
...
class PostprocessDirectSunHours(QueenbeeTask):
    ...
    def run(self):
        yield [DirectSunHoursPostprocess_6aed763bWorkerbee(_input_params=self.map_dag_inputs)]
        pathlib.Path(self.execution_folder).mkdir(parents=True, exist_ok=True)
        self._copy_output_artifacts(self.execution_folder)
        self._copy_output_parameters(self.execution_folder)
...
class _Main_6aed763bOrchestrator(luigi.WrapperTask):
