...
from .dependencies.annual_irradiance_entry_point import _AnnualIrradianceEntryPoint_7f8b9e60Orchestrator as AnnualIrradianceEntryPoint_7f8b9e60Workerbee
...
class RunIrradianceSimulation(QueenbeeTask):
    ...
    def run(self):
        yield [AnnualIrradianceEntryPoint_7f8b9e60Workerbee(_input_params=self.map_dag_inputs)]
...
class _Main_7f8b9e60Orchestrator(luigi.WrapperTask):
