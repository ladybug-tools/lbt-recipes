...
from .dependencies.annual_irradiance_entry_point import _AnnualIrradianceEntryPoint_7d81ce6cOrchestrator as AnnualIrradianceEntryPoint_7d81ce6cWorkerbee
...
class RunIrradianceSimulation(QueenbeeTask):
    ...
    def run(self):
        yield [AnnualIrradianceEntryPoint_7d81ce6cWorkerbee(_input_params=self.map_dag_inputs)]
...
class _Main_7d81ce6cOrchestrator(luigi.WrapperTask):
