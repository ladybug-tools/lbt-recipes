...
from .dependencies.shade_contrib_entry_point import _ShadeContribEntryPoint_35d8ba4bOrchestrator as ShadeContribEntryPoint_35d8ba4bWorkerbee
...
class RunRadianceShadeContribLoop(luigi.Task):
    ...
    def run(self):
        yield [ShadeContribEntryPoint_35d8ba4bWorkerbee(_input_params=self.map_dag_inputs)]
...
class _DynamicShadeContribEntryPoint_35d8ba4bOrchestrator(luigi.WrapperTask):
