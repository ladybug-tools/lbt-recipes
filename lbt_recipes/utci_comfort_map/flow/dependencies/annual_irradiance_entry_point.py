...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_7f8b9e60Orchestrator as AnnualIrradianceRayTracing_7f8b9e60Workerbee


_default_inputs = {   'cpu_count': None,
    'grid_filter': '*',
    'min_sensor_count': None,
    'model': None,
    'north': 0.0,
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_7f8b9e60Workerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_7f8b9e60Orchestrator(luigi.WrapperTask):
    ...
    def requires(self):
        yield [CopyGridInfo(_input_params=self.input_values), CopyRedistInfo(_input_params=self.input_values), CopySunUpHours(_input_params=self.input_values), RestructureDirectResults(_input_params=self.input_values), RestructureTotalResults(_input_params=self.input_values)]
