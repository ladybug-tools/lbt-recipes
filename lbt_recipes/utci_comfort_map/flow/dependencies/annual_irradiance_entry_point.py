...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_7d81ce6cOrchestrator as AnnualIrradianceRayTracing_7d81ce6cWorkerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_7d81ce6cWorkerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_7d81ce6cOrchestrator(luigi.WrapperTask):
