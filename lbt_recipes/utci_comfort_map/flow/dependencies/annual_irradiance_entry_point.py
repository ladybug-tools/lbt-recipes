...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_764ecc30Orchestrator as AnnualIrradianceRayTracing_764ecc30Workerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_764ecc30Workerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_764ecc30Orchestrator(luigi.WrapperTask):
