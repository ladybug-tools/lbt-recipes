...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_b1072e7bOrchestrator as AnnualIrradianceRayTracing_b1072e7bWorkerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_b1072e7bWorkerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_b1072e7bOrchestrator(luigi.WrapperTask):
    ...
    def requires(self):
        yield [AnnualIrradianceRaytracing(_input_params=self.input_values), CopyGridInfo(_input_params=self.input_values), CopySunUpHours(_input_params=self.input_values)]
