...
import flow.main_d1bca667 as breeam_daylight_4b_workerbee
...
class LetBreeamDaylight4bFly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [breeam_daylight_4b_workerbee._Main_d1bca667Orchestrator(_input_params=self._input_params)]
