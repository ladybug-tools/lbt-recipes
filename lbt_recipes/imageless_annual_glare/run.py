...
import flow.main_810c23b0 as imageless_annual_glare_workerbee
...
class LetImagelessAnnualGlareFly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [imageless_annual_glare_workerbee._Main_810c23b0Orchestrator(_input_params=self._input_params)]
