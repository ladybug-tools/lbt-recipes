...
import flow.main_25082223 as imageless_annual_glare_workerbee
...
class LetImagelessAnnualGlareFly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [imageless_annual_glare_workerbee._Main_25082223Orchestrator(_input_params=self._input_params)]
