...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_38ccb15bOrchestrator as AnnualIrradianceRayTracing_38ccb15bWorkerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_38ccb15bWorkerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_38ccb15bOrchestrator(luigi.WrapperTask):
