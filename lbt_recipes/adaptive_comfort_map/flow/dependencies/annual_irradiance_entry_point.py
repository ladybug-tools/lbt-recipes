...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_55884ac0Orchestrator as AnnualIrradianceRayTracing_55884ac0Workerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_55884ac0Workerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_55884ac0Orchestrator(luigi.WrapperTask):
