...
from .dependencies.annual_irradiance_ray_tracing import _AnnualIrradianceRayTracing_7a3b9508Orchestrator as AnnualIrradianceRayTracing_7a3b9508Workerbee
...
class AnnualIrradianceRaytracingLoop(luigi.Task):
    ...
    def run(self):
        yield [AnnualIrradianceRayTracing_7a3b9508Workerbee(_input_params=self.map_dag_inputs)]
...
class _AnnualIrradianceEntryPoint_7a3b9508Orchestrator(luigi.WrapperTask):
