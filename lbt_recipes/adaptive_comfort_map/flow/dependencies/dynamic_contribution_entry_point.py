...
from .dependencies.radiance_contrib_entry_point import _RadianceContribEntryPoint_6b5ce744Orchestrator as RadianceContribEntryPoint_6b5ce744Workerbee
...
class RunRadianceWindowContribLoop(luigi.Task):
    ...
    def run(self):
        yield [RadianceContribEntryPoint_6b5ce744Workerbee(_input_params=self.map_dag_inputs)]
...
class _DynamicContributionEntryPoint_6b5ce744Orchestrator(luigi.WrapperTask):
