...
from .dependencies.spherical_view_factor import _SphericalViewFactor_6b5ce744Orchestrator as SphericalViewFactor_6b5ce744Workerbee
...
class CalculateSphericalViewFactorsLoop(luigi.Task):
    ...
    def run(self):
        yield [SphericalViewFactor_6b5ce744Workerbee(_input_params=self.map_dag_inputs)]
...
class _SphericalViewFactorEntryPoint_6b5ce744Orchestrator(luigi.WrapperTask):
