...
from .dependencies.shade_contrib_entry_point import _ShadeContribEntryPoint_6b5ce744Orchestrator as ShadeContribEntryPoint_6b5ce744Workerbee
...
class RunRadianceShadeContribLoop(luigi.Task):
    ...
    def run(self):
        yield [ShadeContribEntryPoint_6b5ce744Workerbee(_input_params=self.map_dag_inputs)]
...
class _DynamicShadeContribEntryPoint_6b5ce744Orchestrator(luigi.WrapperTask):
