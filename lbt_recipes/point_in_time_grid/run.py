...
import flow.main_b35d7754 as point_in_time_grid_workerbee
...
class LetPointInTimeGridFly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [point_in_time_grid_workerbee._Main_b35d7754Orchestrator(_input_params=self._input_params)]
