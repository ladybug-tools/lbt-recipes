...
import flow.main_c4e2265a as cumulative_radiation_workerbee
...
class LetCumulativeRadiationFly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [cumulative_radiation_workerbee._Main_c4e2265aOrchestrator(_input_params=self._input_params)]
