...
import flow.main_49ddb174 as cumulative_radiation_workerbee
...
class LetCumulativeRadiationFly(luigi.WrapperTask):
    ...
    def requires(self):
        yield [cumulative_radiation_workerbee._Main_49ddb174Orchestrator(_input_params=self._input_params)]
